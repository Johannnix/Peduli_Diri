...
<html lang="en">
  <head>
    ...
    <title>Catat Perjalanan | Peduli Diri</title>
        ...
        <section class="content">
          <div class="card card-info mx-2">
            <div class="card-header">
              <h3 class="card-title">Catat Perjalanan</h3>
            </div>
            <form action="../database/simpan_perjalanan.php" method="POST">
              <div class="card-body">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="lokasi" name="lokasi" placeholder="Masukkan Lokasi" autofocus required>
                  </div>
                </div>
                <div class="form-group row">
              ...
              <div class="card-footer">
                <button type="submit" class="btn btn-info float-right m-2"><i class="fa-solid fa-floppy-disk"></i> Simpan</button>
