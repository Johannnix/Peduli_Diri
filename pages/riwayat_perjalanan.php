...
<html lang="en">
  <head>
    ...
    <title>Riwayat Perjalanan | Peduli Diri</title>
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-tengah align-middle"><a href="edit_catatan.php?no=<?= $value['no']?>" class="btn btn-info mr-2"><i class="fa-solid fa-pencil"></i> Ubah</a>
                        <a onclick="return confirm('Apakah Anda Ingin Menghapus Data ???')" href="../database/hapus_catatan.php?no=<?= $value['no']?>" class="btn btn-danger ml-2"><i class="fa-solid fa-trash-can"></i> Hapus</a></td>
                  </tr>
                  <?php } ?>
                </tbody>
              </table>
